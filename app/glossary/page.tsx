...
const TERMS: Term[] = [
  ...
  },
  {
    word: '単勝',
    reading: 'たんしょう',
    body: '1着になる馬を1頭だけ当てる最もシンプルな馬券。的中率は高めだが、配当は低め。強い馬を素直に買う際に使われる。',
    tags: ['馬券'],
  },
  {
    word: '馬連',
    reading: 'うまれん',
    body: '1・2着に来る馬2頭の組み合わせを着順関係なく当てる馬券。三連複より点数が少なく、初心者にも取り組みやすい。',
    tags: ['馬券'],
  },
  {
    word: '三連複',
    reading: 'さんれんぷく',
    body: '1・2・3着に入る馬3頭を着順関係なく当てる馬券。着順は問わないが3頭すべてを当てる必要があり、高配当が出やすい。このサイトのAI予想はこの三連複フォーメーションを基本に組み立てている。',
    tags: ['馬券'],
  },
  {
    word: '三連単',
    reading: 'さんれんたん',
    body: '1・2・3着に来る馬3頭を着順通りに当てる馬券。三連複より難易度が高いが、その分配当も大きくなりやすい。',
    tags: ['馬券'],
  },
  {
    word: 'オッズ・人気',
    reading: 'おっず・にんき',
    body: 'オッズは馬券の払い戻し倍率。1番人気（最も支持を集めた馬）ほどオッズが低く、下位人気ほど高倍率になる。このサイトでは「〇番人気」という形で市場評価を表している。',
    tags: ['馬券'],
  },
  {
    word: '妙味',
    reading: 'みょうみ',
    body: 'オッズや人気に対して、実際の勝ち目が割高と感じられること。「妙味がある」は「払い戻しが期待値より大きい買い目」という意味で使われる。穴馬を狙う際の判断基準のひとつ。',
    tags: ['馬券'],
  },
  // ── レースの展開・ペース ───────────────────────────────────────
  {
  ...
  {
    word: 'S / C などの略称',
    body: 'レース名末尾に付く略称。S＝ステークス（Stakes）、C＝カップ（Cup）、H＝ハンデキャップ（Handicap）など。例：「天皇賞（春）」は正式には「天皇賞」、「NHKマイルC」のCはカップを指す。',
    tags: ['レース'],
  },
  // ── コース種別 ────────────────────────────────────────────────
  {
